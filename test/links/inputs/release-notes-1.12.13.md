...
[GitHub Octoverse report][GitHub Octoverse report],
...
For more information, see [this post from Ian Hickson][this post from Ian Hickson]
on [flutter-announce][flutter-announce] and the
[breaking change policy on the Flutter wiki][breaking change policy on the Flutter wiki].
...
[Migrating your plugin to the new APIs][Migrating your plugin to the new APIs] documentation,
...
and upgrading it to the [new plugin API][new plugin API].
...
[new plugin API][new plugin API], and made some bug fixes.
...
For more information, refer to [Federated plugins][Federated plugins].
...
We upgraded the Url launcher plugin to the [new plugin API][new plugin API],
...
We upgraded the Video Player plugin to the [new plugin API][new plugin API],
...
We upgraded the Webview Flutter plugin to the [new plugin API][new plugin API],
